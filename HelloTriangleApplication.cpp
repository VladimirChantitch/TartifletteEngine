...
private:
	...
	void createGraphicPipeline() {
		auto vertShadderCode = readFile("shaders/vert.spv");
		auto fragShadderCode = readFile("shaders/frag.spv");

		VkShaderModule vertShaderModule = createShaderModule(vertShadderCode);
		VkShaderModule fragShaderModule = createShaderModule(fragShadderCode);
